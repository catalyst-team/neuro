...
def main(datapath, n_samples):
    ...
    dataframe[dataframe["split"] == 0][["images", "labels", "coords"]].to_csv("data/dataset_train.csv", index=False)
    dataframe[dataframe["split"] == 1][["images", "labels", "coords"]].to_csv("data/dataset_valid.csv", index=False)
