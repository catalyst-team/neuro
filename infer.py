...
class Predictor:
    ...
    def __init__(self, model, volume_shape, subvolume_shape, n_subvolumes,
                 n_classes):
        """Docs."""
        ...
        if len(self.generator.get_coordinates(mode='test')) > n_subvolumes:
            raise ValueError("n_subvolumes must be at least {coords_len}".format(
            ...
            for coords in coords_list:
                ...
                for j in range(predicted.shape[0]):
                    ...
                    for c in range(self.n_classes):
                        one_hot_predicted_segmentation[c, c_j[0, 0]:c_j[0, 1],
                                                       c_j[1, 0]:c_j[1, 1],
